...
class UploaderPlugin extends Gdn_Plugin {
  ...
  public static function PermissionCategory($Category) {
   ...
   /*public function Base_GetAppSettingsMenuItems_Handler($Sender) {
      ...
      $Menu->AddLink('Forum', 'Media', 'plugin/Uploader', 'Garden.Settings.Manage');
   }*/
   ...
   /*public function Controller_Toggle($Sender) {
      $UploaderStatus = Gdn::Config('Plugins.Uploader.Enabled', FALSE);

      $Validation = new Gdn_Validation();
      $ConfigurationModel = new Gdn_ConfigurationModel($Validation);
      $ConfigurationModel->SetField(array('UploaderStatus'));

      // Set the model on the form.
      $Sender->Form->SetModel($ConfigurationModel);

      if ($Sender->Form->AuthenticatedPostBack()) {
         $UploaderStatus = ($Sender->Form->GetValue('UploaderStatus') == 'ON') ? TRUE : FALSE;
         SaveToConfig('Plugins.Uploader.Enabled', $UploaderStatus);
      }

      $Sender->SetData('UploaderStatus', $UploaderStatus);
   ...
   /*public function Controller_Index($Sender) {
      $Sender->Render('Uploader', '', 'plugins/Uploader');
   }*/
    ...
    *
    * Calls UploaderPlugin::PrepareController
    *
    * @access public
    * @param mixed $Sender The hooked controller
    * @see UploaderPlugin::PrepareController
    * @return void
    */
    ...
    *
    * Calls UploaderPlugin::DrawAttachFile
    *
    * @access public
    * @param mixed &$Sender
    * @see UploaderPlugin::DrawAttachFile
    * @return void
    */
...
//      die($Comments);
   ...
   protected function AttachUploadsToComment($Controller, $Type = 'comment') {
      ...
      if (array_key_exists($MediaKey, $MediaList)) {
         ...
         $Controller->SetData('GearImage', $this->GetWebResource('/plugins/Uploader/design/images/gear.png'));
         $Controller->SetData('Garbage', $this->GetWebResource('/plugins/Uploader/design/images/trash.png'));
...
//            'PreviewImageLocation' => Url($PreviewImageLocation),
      ...
      // This needs to have a content type of text/* because it's in an iframe.
      ob_clean();
